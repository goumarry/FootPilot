...
export default function EntrainementsPage() {
  ...
  useEffect(() => {
    getEvenements({ type: 'ENTRAINEMENT' }).then(setEvenements).finally(() => setLoading(false));
  }, []);
    ...
    <AppLayout>
      <div className="p-4 md:p-6 max-w-3xl mx-auto">
        ...
        {loading ? (
          ...
          <EmptyState icon={<Calendar size={22} />} title={tab === 'upcoming' ? t('planning.noUpcoming') : t('planning.noPast')} />
        ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                        <Badge variant="green">{t('planning.training')}</Badge>
      ...
      {selected && (
        <Modal open={!!selected} onClose={() => setSelected(null)} title={t('planning.training')} size="lg">
